...
Este repositório contém os projetos e exercícios desenvolvidos durante o primeiro curso da Formação Java Backend da Alura. O foco principal foi dominar a sintaxe básica e o fluxo de controle da linguagem.

## 🚀 O que eu aprendi:
* Instalação e configuração do ambiente de desenvolvimento (JDK e IntelliJ).
* Manipulação de variáveis e tipos de dados (int, double, String, boolean).
...
## 💻 Projeto Principal
**Leitura e Avaliação de Filmes:** Um console app que processa dados de filmes, calcula médias de notas e decide se um título está incluído no plano do usuário.
